...
#define GLCD_CTRL_RS	PA0	// pin for LCD Register Select
#define GLCD_CTRL_RW	PA1	// pin for LCD Read/Write
#define GLCD_CTRL_E	PA2	// pin for LCD Enable
#define GLCD_CTRL_CS0	PA5	// pin for LCD Controller 0 Chip Select
...
#define GLCD_CTRL_RESET	PA4	// pin for LCD Reset
...
#define GLCD_XPIXELS	192		// pixel width of entire display
...
#define GLCD_TEXT_LINE_LENGTH    33     // internal line length
